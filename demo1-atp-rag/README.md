...
> ## 🗄️ 已归档（2026-08-19）
>
> 本项目停在 **M3e**，核心交付物消融表**一行没跑出来**。
> 后续工作改为在 Java 21 引擎上重做，见 **[`../03-HANDOFF-rag-v2.md`](../03-HANDOFF-rag-v2.md)**。
>
> **这个目录仍然有价值，但价值在文档不在代码**：
> - `DECISIONS.md` 的 26 条决策记录是面试素材库，**代码作废不等于坑没踩过**
> - `corpus/` 的 15 篇中日混排文档 + 80 条案例（含 15 条刻意植入的脏数据）直接迁移到 v2
> - 归档原因的诚实复盘见 v2 文档 §1.2 —— 一句话：**功能做了一堆，评估一行没跑**，
>   而第一天就写了「砍功能，不砍评估」
